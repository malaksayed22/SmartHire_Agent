...
EVALUATION CRITERIA (weight each carefully):
1. Technical Skills Match      — Does the candidate have the required technical skills?
2. Experience Level            — Years of experience vs what is required
3. Education                   — Degree relevance and level
4. Projects & Achievements     — Real-world work, not just listed skills
5. Soft Skills & Communication — Writing clarity, presentation of work
...
INSTRUCTIONS:
- Be specific in strengths and weaknesses — mention actual skills/projects from the resume
- Do NOT give a high score just because the resume is long
- Do NOT penalize for missing optional requirements
- Be honest and objective — this score affects real hiring decisions
...
Reply ONLY with this exact JSON format, no extra text, no markdown, no code blocks:
{{
